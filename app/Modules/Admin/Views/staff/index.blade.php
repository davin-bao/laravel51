...
@section('container')
    <div class="row">
        <div class="col-lg-12">
            {!! Breadcrumbs::render('admin-staff-index') !!}
            <h1><i class="fa fa-home"></i> 用户 <small>列表</small></h1>
        </div>
    </div>
    <div class="row">
        <div class="main-box clearfix">
            <header class="main-box-header clearfix">
                ...
                <div class="filter-block pull-right">
                    ...
                    <a href="{{ adminAction('StaffController@getAdd') }}" class="btn btn-primary pull-right">
...
@section('foot-scripts')
    @parent
    <script type="text/javascript" src="{{ asset('js/admin/staff_index.js') }}"></script>
@endsection